...
using FlowOrchestrator.DestinationEntityManager.Services;
using FlowOrchestrator.DestinationEntityManager.Validators;
...
builder.Services.AddSingleton<IValidator<DestinationEntity>, DestinationValidator>();
