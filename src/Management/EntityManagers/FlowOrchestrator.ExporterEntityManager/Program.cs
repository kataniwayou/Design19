...
using FlowOrchestrator.ExporterEntityManager.Services;
using FlowOrchestrator.ExporterEntityManager.Validators;
...
builder.Services.AddSingleton<IValidator<ExporterEntity>, ExporterValidator>();
builder.Services.AddSingleton<ExporterService>();
