...
builder.Services.AddSingleton<IValidator<SourceAssignmentEntity>, SourceAssignmentValidator>();
builder.Services.AddSingleton<SourceAssignmentService>();
