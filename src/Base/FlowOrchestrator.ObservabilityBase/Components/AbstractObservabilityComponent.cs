...
namespace FlowOrchestrator.ObservabilityBase.Components;

/// <summary>
/// Abstract base class for all observability components in the FlowOrchestrator system.
/// </summary>
public abstract class AbstractObservabilityComponent
{
    /// <summary>
    /// Gets the logger.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="AbstractObservabilityComponent"/> class.
    /// </summary>
    /// <param name="logger">The logger.</param>
    /// <param name="configurationProvider">The configuration provider.</param>
    /// <param name="messageBus">The message bus.</param>
    /// <param name="telemetryProvider">The telemetry provider.</param>
    protected AbstractObservabilityComponent(
        ILogger logger,
