...
/// <summary>
/// Abstract base class for all integration components in the FlowOrchestrator system.
/// </summary>
public abstract class AbstractIntegrationComponent
{
    /// <summary>
    /// Gets the logger.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="AbstractIntegrationComponent"/> class.
    /// </summary>
    /// <param name="logger">The logger.</param>
    /// <param name="configurationProvider">The configuration provider.</param>
    /// <param name="messageBus">The message bus.</param>
    /// <param name="telemetryProvider">The telemetry provider.</param>
    protected AbstractIntegrationComponent(
        ILogger logger,
