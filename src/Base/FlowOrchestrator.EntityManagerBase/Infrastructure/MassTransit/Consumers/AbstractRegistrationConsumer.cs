...
/// <summary>
/// Abstract base consumer for registration messages.
/// </summary>
/// <typeparam name="TMessage">The type of message.</typeparam>
public abstract class AbstractRegistrationConsumer<TMessage> : IConsumer<TMessage>
    where TMessage : class, IMessage
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="AbstractRegistrationConsumer{TMessage}"/> class.
    /// </summary>
    /// <param name="logger">The logger.</param>
    /// <param name="telemetryProvider">The telemetry provider.</param>
    protected AbstractRegistrationConsumer(
        ILogger logger,
